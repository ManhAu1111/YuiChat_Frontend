...
const tabs = [
  ...
  { 
    id: 'profile', 
    name: 'Tôi', 
    icon: '<svg fill="none" class="w-6 h-6" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>' 
  },
  { 
    id: 'settings', 
    name: 'Cài đặt', 
  ...
  <div class="h-16 border-t border-white/20 flex items-center justify-around glass-card flex-shrink-0 text-white rounded-bl-3xl">
    ...
    >
      <div class="relative">
        ...
        <div v-if="tab.id === 'notifications'" class="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-red-500 rounded-full border border-black"></div>
      </div>
