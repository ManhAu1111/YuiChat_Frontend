...
<template>
  <a
    ...
    rel="noopener"
    download
    class="flex items-center gap-3 px-3 py-2.5 rounded-[12px] transition-colors no-underline group"
  ...
  >
    ...
    <!-- Download icon -->
    <svg class="w-4 h-4 flex-shrink-0 opacity-60 group-hover:opacity-100 transition-opacity"
